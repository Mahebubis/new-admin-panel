...
const API = 'https://cit3.internshipstudio.com/admin/react-api/api/support/refund_links.php';
const POLL_MS = 5000;
...
export default function PlacementLinksForRefund() {
    ...
    return (
        <>
        <Helmet>
        <title>Refund Whatsapp Link | Admin Panel</title>
      </Helmet>
            <style>{`
      ...
      `}</style>
            ...
            <div className="rcl-root" style={{
                ...
                <div style={{ flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 10 }}>
                    <div>
                        <div style={{ fontSize: 17, fontWeight: 800, color: '#1e293b' }}>💰 Refund Community Links</div>
                        <div style={{ fontSize: 12, color: '#64748b', marginTop: 2 }}>
                            Manage WhatsApp refund group links — <code style={{ background: '#ede9fe', padding: '1px 5px', borderRadius: 4, color: '#4f46e5', fontSize: 11 }}>whatsapp_placement_club_link_for_refund</code>
                        </div>
                    </div>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        {/* <div style={{
                            ...
                            {loading
                                ? <><span className="rcl-spin" /> Loading...</>
                                : <><span className="live-dot" /> {rows.length} refund links loaded — auto-refreshing every {POLL_MS / 1000}s</>}
                        </div> */}
                            ...
                            <tbody>
                                {!rows.length && !loading ? (
                                    <tr><td colSpan={6} style={{ textAlign: 'center', padding: 50, color: '#94a3b8' }}>
                                        ...
                                        <div style={{ fontSize: 13, fontWeight: 600, color: '#64748b' }}>No refund community links found</div>
                                    </td></tr>
                                ) : rows.map(row => {
